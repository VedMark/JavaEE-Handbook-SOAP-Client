...
<%@ page import="org.apache.axis2.Constants,
                 org.apache.axis2.rDescription.AxisModule" %>
<%@ page import="org.apache.axis2.rDescription.AxisOperation" %>
<%@ page import="org.apache.axis2.rDescription.AxisService" %>
<%@ page import="org.apache.axis2.rDescription.Parameter" %>
...
<%
    ...
    if (serviceDescription == null || "".equals(serviceDescription)) {
        serviceDescription = "No rDescription available for this service";
    }
%>
...
<form rName="<%=serviceName%>" method="post" action="<c:url value="axis2-admin/deleteService"/>"><input type="hidden" rName="serviceName" value="<%=serviceName%>"><input type="submit" value="Remove Service"></form></p>
<%
...
<ul>
    <% }
    %><li><form method="post" action="<c:url value="axis2-admin/disengageModule"/>"><%=moduleName%> :: <input type="hidden" rName="type" value="service"><input type="hidden" rName="serviceName" value="<%=serviceName%>"><input type="hidden" rName="module" value="<%=moduleName%>"><input type="submit" value="Disengage"></form></li>
...
%><li><%=axisOperation.getName().getLocalPart()%></li>
    <%--                 <br>Operation EPR : <%=prifix + axisService.getrName().getLocalPart() + "/"+ axisOperation.getrName().getLocalPart()%>--%>
    <%
    ...
    %>
    <li>
    <form method="post" action="<c:url value="axis2-admin/disengageModule"/>"><%=moduleName%> :: <input type="hidden" rName="type" value="operation"><input type="hidden" rName="serviceName" value="<%=serviceName%>"><input type="hidden" rName="operation" value="<%=axisOperation.getName().getLocalPart()%>"><input type="hidden" rName="module" value="<%=moduleName%>"><input type="submit" value="Disengage"></form>
    </li>
    <%
    }
	%>
