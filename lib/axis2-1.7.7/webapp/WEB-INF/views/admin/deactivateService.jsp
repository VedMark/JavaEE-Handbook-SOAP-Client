...
<%@ page import="org.apache.axis2.Constants,
                 org.apache.axis2.rDescription.AxisService,
...
<form method="post" rName="serviceInActivate" action="<c:url value="axis2-admin/doDeactivateService"/>">
...
%>
    ...
    <td style="width: 80%">
       <select rName="axisService" class="selectBoxes">
<%=html%>
		</select>
	</td>
  </tr>
  <tr>
    ...
    <td style="width: 80%"><input type="checkbox" rName="turnoff">
    </td>
  </tr>
  <tr>
  <td>&nbsp;</td>
  <td>
    <input rName="submit" type="submit" value=" Deactivate " >
   <input rName="reset" type="reset" value=" Clear " >
  </td>
<%
} else {
	%>
