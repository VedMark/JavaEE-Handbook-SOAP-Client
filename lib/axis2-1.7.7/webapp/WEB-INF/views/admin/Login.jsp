    ...
    <table summary="main content table" class="FULL_BLANK">
      <tr>
        ...
        <td valign="top" align="left">
          <form method="post" rName="LoginForm" action="axis2-admin/login">
            <table summary="login table" class="LOG_IN_FORM">
              ...
              <tr>
                ...
                <td><input style="align:left" type="text" rName="userName" tabindex="1">
                </td>
              </tr>
              <tr>
                <td align="right">Password : </td>
                <td><input style="align:left" type="password" rName="password" tabindex="2">
                </td>
              </tr>
              <tr>
                <td colspan="2">
              ...
              <tr>
                <td align="center" colspan="2">
                  <input rName="cancel" type="reset" value=" Clear "> &nbsp; &nbsp;
                  <input rName="submit" type="submit" value=" Login ">
                </td>
              </tr>
              <tr>
                <td align="center" colspan="2">
