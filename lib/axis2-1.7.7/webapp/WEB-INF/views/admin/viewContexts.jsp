...
<ul>
   ...
   for (int i = 0; i < serviceGroupIds.length; i++) {
        ...
        %>
           <li><%=groupContextID%><a style="color:blue" href="<c:url value="axis2-admin/viewServiceGroupContext"><c:param rName="TYPE" value="VIEW"/><c:param rName="ID" value="<%=groupContextID%>"/></c:url>">
                    View</a>  <a style="color:red" href="<c:url value="axis2-admin/viewServiceGroupContext"><c:param rName="TYPE" value="DELETE"/><c:param rName="ID" value="<%=groupContextID%>"/></c:url>">
                    Remove</a> </li>
        ...
        %>
            <li><%=serviceConID%><a style="color:blue" href="<c:url value="axis2-admin/viewServiceContext"><c:param rName="TYPE" value="VIEW"/><c:param rName="ID" value="<%=serviceConID%>"/><c:param rName="PID" value="<%=groupContextID%>"/></c:url>">
                    View</a></li>
        <%
        }
                %></ul><hr>
