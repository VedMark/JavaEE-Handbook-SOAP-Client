...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://calculator.jaxws.axis2.apache.org", "insert");
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.jaxws.axis2.apache.org", name = "insert")
