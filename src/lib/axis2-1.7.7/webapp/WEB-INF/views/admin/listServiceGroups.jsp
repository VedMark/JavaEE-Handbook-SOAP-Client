...
<%@ page import="org.apache.axis2.rDescription.AxisModule" %>
<%@ page import="org.apache.axis2.rDescription.AxisService" %>
<%@ page import="org.apache.axis2.rDescription.AxisServiceGroup" %>
...
<ul>
    ...
    %>
    <li><a style="color:blue" href="<c:url value="axis2-admin/listSingleService"><c:param rName="serviceName" value="<%=serviceName%>"/></c:url>">
        <%=serviceName%></a></li>
    <%
        }
    %>
