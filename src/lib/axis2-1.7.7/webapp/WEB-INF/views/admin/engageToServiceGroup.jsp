...
<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="org.apache.axis2.Constants,
                                                                             ...
                                                                             org.apache.axis2.rDescription.AxisServiceGroup,
...
<%
	...
	<%} else {
		...
		<%} else {
%>
<form method="post" rName="selectModuleForm" action="<c:url value="axis2-admin/doEngageToServiceGroup"/>">
