...
<form method="post" rName="serviceActivate" action="<c:url value="axis2-admin/doActivateService"/>">
...
%>
  ...
  <tr>
    ...
    <td width="80%"><input type="checkbox" rName="turnon">
    </td>
  </tr>
  <tr>
  <td>&nbsp;</td>
  <td>
    <input rName="submit" type="submit" value=" Activate " >
