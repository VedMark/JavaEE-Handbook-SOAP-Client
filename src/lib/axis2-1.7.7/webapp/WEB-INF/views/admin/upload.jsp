...
<form method="post" rName="Axis2upload" id="Axis2upload" action="<c:url value="axis2-admin/doUpload"/>"
      enctype="multipart/form-data">
  <table summary="main content table">
    <tr>
      <td>Service archive : </td>
      <td><input id="serviceUpload" type="file" rName="filename" size="50"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input rName="upload" type="button" onclick="javascript:checkFileUpload();" value=" Upload "></td>
    </tr>
  </table>
</form>
<blockquote>
