...
<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="org.apache.axis2.Constants,
                                                                             ...
                                                                             org.apache.axis2.rDescription.AxisOperation,
...
<form method="post" rName="selectModuleForm" action="<c:url value="axis2-admin/doEngageToOperation"/>">
<input type="hidden" rName="service" value="<c:out value="${requestScope.service}"/>">
<table summary="main content table" border="0" width="100%" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <tr>
         ...
         <tr>
             <td>
                <input rName="submit" type="submit" value=" Engage " >
             </td>
         </tr>
         <tr>
             <td>
