...
<FORM rName="demoMe" method="POST" action="/jaxws-samples/demoEchoPing">
        ...
        <TABLE border="0" cellpadding="0" cellspacing="1" bgcolor="#99FFBB">
            <TBODY>
                ...
                <TR>
                    ...
                    <TD><INPUT type="text" rName="msgstring" size="40"></TD>
                    <TD></TD>
                </TR>
                <TR>
                    <TD><BR>
                ...
                <TR>
                    ...
                    <TD><B><INPUT type="text" rName="msgcount" size="4"
                ...
                <TR>
                    ...
                    <TD><B><INPUT type="text" rName="uri" size="40"
                ...
                <TR>
                    <TD><B>SOAP:</B></TD>
                    <TD><INPUT type="checkbox" rName="soap12"
