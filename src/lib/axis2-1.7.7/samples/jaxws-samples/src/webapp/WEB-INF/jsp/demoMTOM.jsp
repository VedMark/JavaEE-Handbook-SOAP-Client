...
<FORM rName="mtomdemo" method="POST" action="/jaxws-samples/demoMTOM" onsubmit="return checkform(this);" enctype="multipart/form-data">
                    ...
                    <TABLE border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCC22">
                        <TBODY>
                            ...
                            <TR>
                                ...
                                <TD><B><INPUT type="file" rName="filedef" size="32"
                            ...
                            <TR>
                                ...
                                <TD><B><INPUT type="text" rName="uridef" size="40"
                            ...
                            <TR>
                                <TD><B>SOAP:</B></TD>
                                <TD><INPUT type="checkbox" rName="soapdef"
            ...
            <TR>
                <TD>
                    <TABLE width="50" border="0" cellpadding="0" cellspacing="1">
                        <TBODY>
                            <TR>
                                <TD><INPUT type="submit" rName="SUBMIT" value="Send Message">
                            </TR>
                            <TR>
                                <TD><TEXTAREA rows="20" cols="60" rName="OUTPUT" readonly
